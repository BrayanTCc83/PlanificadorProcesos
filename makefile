...
TEMPORAL=tmp
BUILD=build
INPUTS=Main proceso/Proceso proceso/GestorProcesos algoritmo/PlanificadorRoundRobin estructura/ColaSimple estructura/ColaOrdenada memoria/GestorMemoria patrones/observer/Observador patrones/observer/Observable
